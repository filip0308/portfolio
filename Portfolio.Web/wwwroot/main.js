...
var ProductService = /** @class */ (function () {
    function ProductService(http) {
        this.http = http;
        this.productUrl = 'https://dev-portfolio.azurewebsites.net/api/products';
    }
    ...
    ProductService.prototype.getProduct = function (id) {
        return this.getProducts().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (products) { return products.find(function (p) { return p.id == id; }); }));
    };
...
module.exports = __webpack_require__(/*! C:\Users\kozhata\Documents\GitHub\portfolio\Portfolio.Web\app\src\main.ts */"./src/main.ts");
